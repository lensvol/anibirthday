...
CREATE TABLE tweet_templates("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "template" VARCHAR(140));
CREATE TABLE "birthdays"(id integer primary key autoincrement, name TEXT, day INTEGER, month INTEGER, series TEXT, original_name TEXT, photo TEXT, important BOOLEAN, charid INTEGER, UNIQUE(name, day, month));
